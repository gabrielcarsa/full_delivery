            ...
            <div class="row p-3">
                ...
                <div class="col d-flex align-items-center justify-content-end p-0">
                    <a class="btn bg-white text-padrao mr-2 py-1 shadow-sm px-2 fw-semibold d-flex align-items-center justify-content-center"
                        href="{{ route('product_categories.importarCardapioIfood') }}">
            ...
            <div class="my-3 p-0 bg-white border rounded">
                ...
                <div class="border-bottom d-flex align-items-start justify-content-between p-3">
                    <div class="d-flex relative">
                        ...
                        <div
                            class="position-absolute start-0 top-0 bg-warning py-1 px-2 d-flex align-items-center rounded">
                        ...
                        <div class="px-2">
                            ...
                            @if($produto->tempo_preparo_min_minutos != null && $produto->tempo_preparo_max_minutos !=
                            null)
