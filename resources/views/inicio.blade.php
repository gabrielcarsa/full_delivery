...
<body class="">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        ...
                        @endauth
                        @endif
                        <a class="btn btn-primary fw-bold mx-1" href="{{ route('register') }}">
                            Registre-se
                        </a>
                    </li>
                </ul>
    ...
    <section class="container row min-vh-100 bg-primary text-white align-items-center">
        <div class="col-md-6">
            <h2 class="fs-1 fw-bolder">
                Sistema completo de delivery em PHP - Laravel
            </h2>
            <p class="fs-4 text-white-50">
                Integração iFood, cardápio digital, financeiro completo, gestor de pedidos, plataforma delivery.
            </p>
        </div>
