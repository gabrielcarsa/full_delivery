...
<body class="font-sans antialiased">
    ...
    <div class="bg-body-tertiary min-h-screen">
        ...
        <main>
            <div class="d-flex w-100">
                ...
                <!-- SIDEBAR -->
                <div class="collapse collapse-horizontal show sticky" id="collapseSidebar">

                    <div class="m-0 border-end bg-white min-vh-100 p-3">
                        ...
                        <div class="dropdown mx-3 border bg-light rounded">
                            ...
                            <ul class="dropdown-menu p-3 bg-light dropdown-menu-end" style="width: 400px">
                                ...
                                @foreach($stores as $store)
                                <li
                                    class="d-flex align-items-center justify-content-between rounded {{session('selected_store') && session('selected_store')['id'] == $store->id ? 'border-3 border-primary' : 'bg-white'}} p-3">
                                    ...
                                    <form action="{{route('store.select', ['id' => $store->id])}}" method="post">
                                        @csrf
                                        <button type="submit"
                                            class="mx-2 p-2 text-white fw-semibold rounded w-100 bg-primary">
                                            Selecionar loja
                                        </button>
                                    </form>
                                    @endif
