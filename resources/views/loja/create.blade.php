        ...
        <div class="col-6">
            ...
            <div class="d-flex justify-content-between d-flex align-items-center" style="margin: 30px 5%">
                ...
                <div class="d-flex align-items-center">
                    <div
                        class="rounded-circle px-2 mr-2 {{!request('step') ? 'bg-padrao' : 'bg-clear'}}">
                ...
                <div class="d-flex align-items-center">
                    <div class="rounded-circle px-2 mr-2 {{request('step') && request('step') == 2 ? 'bg-padrao' : 'bg-clear'}}">
                        <p class="m-0 fw-bold fs-5 text-white">
                            2
                        </p>
                    </div>
                ...
                <div class="d-flex align-items-center">
                    <div class="rounded-circle px-2 mr-2 {{request('step') && request('step') == 3 ? 'bg-padrao' : 'bg-clear'}}">
                        <p class="m-0 fw-bold fs-5 text-white">
                            3
                        </p>
                    </div>
                ...
                <div class="d-flex align-items-center">
                    <div class="rounded-circle px-2 mr-2 {{request('step') && request('step') == 4 ? 'bg-padrao' : 'bg-clear'}}">
                        <p class="m-0 fw-bold fs-5 text-white">
                            4
                        </p>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 my-2">
                        ...
                        <select class="form-select @error('tipo') is-invalid @enderror" name="tipo"
                            ...
                            <option {{old('tipo') == "pizzaria" ? 'selected' : ''}} value="pizzaria">Pizzaria</option>
                            <option {{old('tipo') == "lanchonete" ? 'selected' : ''}} value="lanchonete">Lanchonete
                            </option>
                            <option {{old('tipo') == "dogueira" ? 'selected' : ''}} value="dogueira">Dogueira (hot dogs)
                            </option>
                            <option {{old('tipo') == "creperia" ? 'selected' : ''}} value="creperia">Creperia</option>
                            ...
                            <option {{old('tipo') == "comida_chinesa" ? 'selected' : ''}} value="comida_chinesa">Comida
                                Chinesa</option>
                            <option {{old('tipo') == "comida_indiana" ? 'selected' : ''}} value="comida_indiana">Comida
                                Indiana</option>
                            ...
                            <option {{old('tipo') == "comida_nordestina" ? 'selected' : ''}} value="comida_nordestina">
                                Comida Nordestina</option>
                            <option {{old('tipo') == "comida_mineira" ? 'selected' : ''}} value="comida_mineira">Comida
                                Mineira</option>
                            <option {{old('tipo') == "restaurante_vegano" ? 'selected' : ''}}
                                value="restaurante_vegano">Restaurante Vegano/Vegetariano</option>
                            <option {{old('tipo') == "frutos_do_mar" ? 'selected' : ''}} value="frutos_do_mar">Frutos do
                                Mar</option>
                            <option {{old('tipo') == "steakhouse" ? 'selected' : ''}} value="steakhouse">Steakhouse
                            </option>
                            <option {{old('tipo') == "confeitaria" ? 'selected' : ''}} value="confeitaria">Confeitaria
                            </option>
                            ...
                            <option {{old('tipo') == "suqueria" ? 'selected' : ''}} value="suqueria">Suqueria (Sucos
                                Naturais)</option>
                            <option {{old('tipo') == "comida_fit" ? 'selected' : ''}} value="comida_fit">Comida Fit/Low
                                Carb</option>
                    ...
                    <div class="col-md-6 my-2">
                        ...
                        <select class="form-select @error('faturamento_mensal') is-invalid @enderror"
                            ...
                            <option {{old('faturamento_mensal') == "CATEGORIA 1" ? 'selected' : ''}} value="CATEGORIA 1">Até 5 mil
                                reais</option>
                            <option {{old('faturamento_mensal') == "CATEGORIA 2" ? 'selected' : ''}} value="CATEGORIA 2">De 5 mil até
                                25 mil reais</option>
                            <option {{old('faturamento_mensal') == "CATEGORIA 3" ? 'selected' : ''}} value="CATEGORIA 3">De 25 mil até
                                80 mil reais</option>
                            <option {{old('faturamento_mensal') == "CATEGORIA 4" ? 'selected' : ''}} value="CATEGORIA 4">De 80 mil até
                                100 mil reais</option>
                            <option {{old('faturamento_mensal') == "CATEGORIA 5" ? 'selected' : ''}} value="CATEGORIA 5">Mais de 100
                                mil reais</option>
                        </select>
                    </div>
                </div>
